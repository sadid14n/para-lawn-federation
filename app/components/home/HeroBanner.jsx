...
export default function HeroBanner() {
  ...
  return (
    <div className="relative w-full h-[75vh] md:h-[80vh] lg:h-[90vh] overflow-hidden bg-gray-900 group">
      ...
      {/* THE OVERLAY CURTAIN - Updated to Federation Deep Navy Blue */}
      <div 
      ...
      <div className="absolute inset-0 z-30 flex flex-col items-center justify-center bg-gradient-to-t from-black/90 via-black/50 to-black/20 pb-10 md:pb-0">
        <div className="text-center px-4 md:px-6 max-w-4xl mx-auto flex flex-col items-center mt-8 md:mt-12 w-full">
          ...
          {/* Aesthetic Tagline */}
          <span className="inline-block py-1 px-3 sm:py-1.5 sm:px-4 rounded-full bg-white/20 backdrop-blur-md border border-white/30 text-white text-[9px] sm:text-xs md:text-sm font-bold tracking-[0.1em] md:tracking-[0.2em] uppercase mb-4 md:mb-6 shadow-sm">
         ...
         {/* Main Headline */}
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-white mb-6 md:mb-6 drop-shadow-lg uppercase tracking-tight leading-[1.1] md:leading-[1.1] w-full">
            ...
            <span className="text-[#EF7D20] block sm:inline mt-1 sm:mt-0 drop-shadow-[0_4px_20px_rgba(239,125,32,0.3)]">
              On The Green.
            </span>
          </h1>
          ...
          <div className="flex flex-row justify-center gap-2 sm:gap-4 w-full sm:w-auto px-2 sm:px-0 mt-2 sm:mt-0">
            ...
            <Link 
              href="/register" 
              className="flex items-center justify-center bg-[#EF7D20] hover:bg-[#d66a15] text-white w-auto px-4 sm:px-8 py-3 sm:py-3.5 md:py-4 rounded-full font-bold text-[11px] sm:text-sm md:text-base transition-all duration-300 shadow-[0_10px_20px_rgba(239,125,32,0.3)] hover:shadow-[0_15px_30px_rgba(239,125,32,0.5)] hover:-translate-y-1 whitespace-nowrap"
            >
              Register Athlete
            </Link>
            ...
            <Link 
              href="/about" 
              className="group flex items-center justify-center bg-white/10 hover:bg-white text-white hover:text-[#1E2265] backdrop-blur-md border border-white/30 w-auto px-4 sm:px-8 py-3 sm:py-3.5 md:py-4 rounded-full font-bold text-[11px] sm:text-sm md:text-base transition-all duration-300 hover:-translate-y-1 whitespace-nowrap"
            >
              Discover Sport
